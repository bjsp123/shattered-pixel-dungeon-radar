					...
					reset(hero.sprite,
							...
							new Callback() {
								...
								public void call() {
									...
									int dmg = Math.round(Hero.heroDamageIntRange(min, max) * Dungeon.playstyle.getActualMultiplier(PlaystyleConfig.PLAYSTYLE_MAGIC_DAMAGE));
									enemy.damage(dmg, HolyLance.this);
